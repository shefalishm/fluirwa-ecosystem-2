...
const CATEGORIES = [
  ...
  },
  {
    ...
    vendors: [
      { name: "Brands Essential", url: "https://brandsessential.com", desc: "Boutique B2B marketing consultancy specializing in fintech, RWA tokenization, and Web3 go-to-market strategy with deep ABM and cold outreach expertise", tags: ["Fintech","RWA","ABM","GTM Strategy"], hq: "India", founded: 2024 },
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1400px", margin: "0 auto", padding: "20px" }}>
        ...
        <div style={{ textAlign: "center", padding: "40px 20px 30px", marginBottom: "20px" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            <div style={{ width: "48px", height: "48px", borderRadius: "12px", background: "linear-gradient(135deg, #00D4AA, #7B68EE)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", fontWeight: 900, color: "#0a0e17", boxShadow: "0 0 30px rgba(0,212,170,0.3)" }}>F</div>
        ...
        <div style={{ textAlign: "center", padding: "40px 20px", borderTop: "1px solid #ffffff0a", marginTop: "20px" }}>
          <p style={{ color: "#445566", fontSize: "12px", margin: 0 }}>
            © 2026 FluidRWA Vendor Ecosystem — {TOTAL_VENDORS} vendors across {CATEGORIES.length} categories — Data compiled for reference purposes
          </p>
        </div>
      </div>
    </div>
